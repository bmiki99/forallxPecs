...
A \define{proper name} egy olyan szinguláris kifejezés, amely kiválasztja az egyént anélkül, hogy leírná. Az ’Emerson’ név egy tulajdonnév és a név önmagában semmit nem árul el Emersonról. Természetesen néhány névhez férfi, néhányhoz női nemet rendelünk. Ha ’Jack Hathaway’ szinguláris kifejezéshez van használva, kitalálható, hogy egy férfire vonatkozik. Habár a név nem feltétlenül jelenti azt, hogy a hivatkozott személy férfi, vagy még azt sem, hogy egy személyre utal. Jack lehet egy zsiráf is, ha csak a név alapján mondhatnád meg. Nagyon sok filozofikus cselekvés folyik e kérdés körül, de az fontos pont, hogy a név egy szinguláris kifejezés, mert egyetlen, konkrét személyt választ ki. 
...
A szinguláris kifejezéseket konstansnak nevezzük, mert konkrét egyént választanak ki. Jegyezd meg, hogy $x, y$, and $z$ nem konstansok a QL-ben. Ezek \define{változók}, betűk, amelyek semmilyen konkrét dolgot nem képviselnek. Szükségünk lesz rájuk, mikor bevezetjük a mennyiségeket.
